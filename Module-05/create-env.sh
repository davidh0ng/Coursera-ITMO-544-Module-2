...
aws s3api create-bucket --bucket ${19} --create-bucket-configuration LocationConstraint=${17}
echo "Created S3 bucket: ${19}..."

echo "Creating S3 bucket: ${20}..."
aws s3api create-bucket --bucket ${20} --create-bucket-configuration LocationConstraint=${17}
